...
public class CrudJava {
    ...
    public static void AddRecord() throws IOException {
        ...
        BufferedWriter bw = new BufferedWriter(new FileWriter("kelompok_14.txt", true));
        Scanner strInput = new Scanner(System.in);
    ...
    public static void ViewAllRecord() throws IOException {
        BufferedReader br = new BufferedReader(new FileReader("kelompok_14.txt"));
    ...
    public static void DeleteRecordByID() throws IOException {
        ...
        File tempDB = new File("kelompok_14_temp.txt");
        File db = new File("kelompok_14.txt");
